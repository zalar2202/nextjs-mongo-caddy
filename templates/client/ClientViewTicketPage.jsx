...
import clientGetTicketByNumber from '@/functions/client/clientGetTicketByNumber';
...
import ClientTicketMessage from '@/components/common/ClientTicketMessage';

export default function ClientViewTicketPage({ ticketNo }) {
