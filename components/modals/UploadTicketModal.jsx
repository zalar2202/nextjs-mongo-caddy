...
import clientUploadTicketFile from '@/functions/client/clientUploadTicketFile';
...
function UploadTicketModal(props) {
                    ...
                    {pickup && (
                        <DialogContent dividers>
                            <Typography gutterBottom variant="h6">
                                شما در حال آپلود فایل بلیت هستید.
                            </Typography>
